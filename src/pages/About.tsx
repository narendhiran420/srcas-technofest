...
export default function About() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-16">
      <SEO title="About Department | Dept. of B.Sc. IT, SRCAS" description="Learn about the Department of B.Sc. Information Technology at Sri Ramakrishna College of Arts and Science, Coimbatore — vision, mission, and values." />
      ...
      <Reveal delay={0.15} className="glass-card mt-10 p-8 leading-relaxed text-paper-100/75">
        <p>
          The Department of B.Sc. Information Technology at Sri Ramakrishna College of Arts and Science, Coimbatore,
